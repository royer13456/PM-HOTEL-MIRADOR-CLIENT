    ...
    <div>
      <div className='relative'>
        ...
        <div className='min-w-max flex flex-col gap-44 absolute top-[45%] left-[50%] transform -translate-x-1/2 -translate-y-1/2'>
          <h1 className='font-bold text-5xl '>HOTEL MIRADOR TORRE TORRE</h1>
          <a className='bg-[#5cb16e] m-auto px-6 py-2 mt-35 rounded' href="/Habitaciones">RESERVAR</a>
        </div>
      </div>

      <div className='mx-32 mb-20 flex flex-row flex-wrap justify-between relative'>
        <section>
          <div>
            <img className='w-80 mt-8' src="/hotel-portada.jpg" alt="" />
          </div>
        </section>
      ...
      <div className='relative'>
        ...
        <div className='absolute top-[10%] px-14 w-[100%] flex flex-col'>
          <div className='flex justify-center'>
            <h2 className='font-bold text-3xl'>¿QUÉ OFRECEMOS?</h2>
          </div>
          <div className='flex flex-row flex-wrap justify-between mt-10'>
            <section className='w-72 bg-slate-200 px-6 py-6'>
              <div className='flex flex-row content-center gap-5 items-center mb-4'>
      ...
      <div className='my-20 px-36 flex flex-col'>
        <div className='flex justify-center'>
          <h2 className='font-bold text-3xl'>Recomendaciones</h2>
        </div>
        <div className='mt-16 flex flex-row flex-wrap justify-between'>
          <section className='bg-[#e1e0e0ca] px-2 py-2 rounded-xl border-1'>
            <img className='w-56' src="/hotel-doscamas.jpg" alt="" />
            <div className='mt-4 flex flex-col items-center'>
              <p className='font-bold mb-8'>Doble cama</p>
          ...
          <section className='bg-[#e1e0e0ca] px-2 py-2 rounded-xl'>
            <img className='w-56' src="/hotel-doscamas.jpg" alt="" />
            <div className='mt-4 flex flex-col items-center'>
              <p className='font-bold mb-8'>Vip</p>
              <a className='bg-[#5cb16e] mb-4 px-5 py-1' href="">Reservar</a>
            </div>
          </section>
          <section className='bg-[#e1e0e0ca] px-2 py-2 rounded-xl'>
            <img className='w-56' src="/hotel-doscamas.jpg" alt="" />
            <div className='mt-4 flex flex-col items-center'>
              <p className='font-bold mb-8'>Presidencial</p>
              <a className='bg-[#5cb16e] mb-4 px-5 py-1' href="">Reservar</a>
            </div>
          </section>
        </div>
      ...
      <div className='flex flex-row justify-between mx-32 mt-40 mb-36'>
        <div >
          <iframe className='w-[550px] h-[300px] my-5'  src="https://goo.gl/maps/uNkM3Uror6WWmcct6" frameborder="0" ></iframe>
        </div>
        <div className='bg-[#e1e1e176] border-solid border-[1px] border-slate-600'>
          <div className='px-5 py-10'>
            <h2 className='font-bold text-center mb-10'>EL MIRADOR TORRE TORRE</h2>
